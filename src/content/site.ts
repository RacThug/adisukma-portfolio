export const site = {
  ...
  tagline: {
    pre: "Building ",
    highlight: "real-world production",
    post: " web apps with Next.js, NestJS & TypeScript, end to end and AI-first.",
  },
  intro:
  ...
  shortBio:
    "I'm a fullstack web developer based in Denpasar, Bali, with hands-on experience shipping full-scale production web applications. I work across the stack, with React / Next.js on the frontend, NestJS / Node.js (plus PHP / Symfony) on the backend, and TypeScript end to end. I develop AI-first, using AI coding assistants as a core part of how I plan, build, review, and ship.",
  longBio: [
    "I'm a fullstack web developer who enjoys turning messy, manual processes into clean, reliable software. Over the past year I've contributed to several production systems, from a compliance platform that automates regulatory document generation to a customized e-commerce store.",
